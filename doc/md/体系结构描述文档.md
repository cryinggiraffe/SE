...
|                    接口                    |  服务调用方   |  服务提供方   |
| :--------------------------------------: | :------: | :------: |
| CategoryBLService, GoodBLService, ViewBLService, GiftBLService, SuperviseBLService, ClientBLService, ImportBLService, SaleBLService, FinanceBLService, PromotionBLService, ApproveBLService, SystemBLService（未填完） |  客户端展示层  | 客户端业务逻辑层 |
| CategoryDataService, GoodDataService, ViewDataService, GiftDataService, SuperviseDataService, ClientDataService, ImportDataService, SaleDataService, FinanceDataService, PromotionDataService, ApproveDataService, SystemDataService(未填完) | 客户端业务逻辑层 | 服务器端数据层  |
...
##### **语法:**public ResultMessage check(SearchType type)
...
##### **语法:**public ResultMessage gift_recommend(SearchType type)
...
##### **语法:**public ResultMessage gift_choose(SearchType type)
...
##### **语法:**public ResultMessage gift_commit(SearchType type)
...
| :--------------------------------------: | :-------------: |
|                 销售表单的接口                  |                 |
| TranslationSituationDataService.findAll() | 根据id进行查找所有持久化对象 |
|                  库存表单接口                  |                 |
|                                          |                 |
...
| :--------------------------------------: | :------------------: |
|                 销售表单的接口                  |                      |
| SaleSituationDataService.findForList(SaleSituationVo saleSituationVo) | 根据id进行查找所有符合条件的持久化对象 |
|                  库存表单接口                  |                      |
|                                          |                      |
...
**语法TranslationSituationDataService.findAll()**
...
**SaleSituationDataService.findForList(SaleSituationPo saleSituationPo)**
...
数据库中包括Category表、Good表、Gift表、Receipt表，Appliction表、Message表、UserClassPromtion表、CommodityPromotion表、PricePromotion表