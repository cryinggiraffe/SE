...
##### **语法:**public ResultMessage addCategory(CategoryVO cvo)
...
##### **语法:**public ResultMessage deleteCategory(CategoryVO cvo)
...
##### **语法:**public ResultMessage editCategory(CategoryVO cvo)
...
##### **语法:**public ResultMessage addCategory(CategoryVO avo)
...
##### **语法:**public ResultMessage deleteCategory(CategoryVO avo)
...
##### **语法:**public ResultMessage editCategory(CategoryVO avo)
...
![新建客户的顺序图](E:\sehomework\SEhomework\doc\img\新建客户的顺序图.png)
...
![importbl模块各个类的设计](E:\sehomework\SEhomework\doc\img\importbl模块各个类的设计.png)

##### （4）业务逻辑层的动态模型

![新建进货单单的顺序图](E:\sehomework\SEhomework\doc\img\新建进货单单的顺序图.png)
...
![salebl模块各个类的设计](E:\sehomework\SEhomework\doc\img\salebl模块各个类的设计.png)

（4）业务逻辑层的动态模型

![新建销售单的顺序图](E:\sehomework\SEhomework\doc\img\新建销售单的顺序图.png)
