...
public class Good {
    ...
    //定义几个初始节点
    DefaultMutableTreeNode root = new DefaultMutableTreeNode("所有商品");
    DefaultMutableTreeNode guangdong = new DefaultMutableTreeNode("洗漱用品");
    DefaultMutableTreeNode guangxi = new DefaultMutableTreeNode("饮料");
    DefaultMutableTreeNode foshan = new DefaultMutableTreeNode("牙刷");
    DefaultMutableTreeNode shantou = new DefaultMutableTreeNode("牙膏头");
    DefaultMutableTreeNode guilin = new DefaultMutableTreeNode("牛奶");
    DefaultMutableTreeNode nanning = new DefaultMutableTreeNode("可口可乐");
