...
public class CategoryDataServiceImpl implements CategoryDataService{
	...
	public boolean insert(CategoryPO categoryPO) {
		...
		return dao.update(sql, categoryPO.getId() , categoryPO.getPid(), categoryPO.getName());
	}
	...
	public boolean update(CategoryPO categoryPO) {
		// TODO Auto-generated method stub
		String sql = "update Category set pid = ? , name = ? where id = ?";
		return dao.update(sql, categoryPO.getPid(), categoryPO.getName() , categoryPO.getId() );
	}
...
//	}
	...
	public CategoryPO findForId(String id) {
		...
		return dao.get(CategoryPO.class, sql, id);
	}
